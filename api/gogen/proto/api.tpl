...
type (
    // The response data of {{.modelEnglishName}} information | {{.modelChineseName}}信息
    {{.modelName}}Info {
    ...
    {{.modelName}}ListResp {
        ...
        // {{.modelName}} list data | {{.modelChineseName}}信息列表数据
    ...
    {{.modelName}}InfoResp {
        ...
        // The {{.modelEnglishName}} information | {{.modelChineseName}}信息数据
        Data {{.modelName}}Info `json:"data"`
    }
)
